...
/**
 * <a href="https://github.com/AlpsBTE/Plot-System/blob/5e0ecacfcc41e4f0bb42c656736bb2d21a2c6912/src/main/java/com/alpsbte/plotsystem/core/system/Builder.java#L57">
 *     Original File
 * </a>
 */
public class Builder {
    ...
    public int getPlotID(Slot slot) throws SQLException {
...
//    }
    ...
    public PlotType getPlotTypeSetting() {
        ...
        try (ResultSet rs = DatabaseConnection.createStatement("SELECT setting_plot_type FROM plotsystem_builders WHERE uuid = ?")
            ...
            DiscordPS.error("An error occurred while getting language setting from database", ex);
        }
        return null;
    }
    ...
    public static class Reviewer {
        ...
        public List<Country> getCountries() {
            ...
            return countries.stream().map(c -> {
                ...
                } catch (SQLException ex) {DiscordPS.error("A SQL error occurred!", ex);}
                return null;
